		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="index.php" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">Smart</span>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('front-assets/images/prod-1.jpg')}}" alt=""></a>
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('front-assets/images/carousel-3-m.jpg')}}" alt=""></a>
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('front-assets/images/product-9.jpg')}}" alt=""></a>
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
...
<script src="{{ asset('fron-assets/js/jquery-3.6.0.min.js') }}"></script>
<script src="{{ asset('fron-assets/js/bootstrap.bundle.5.1.3.min.js') }} "></script>
<script src="{{ asset('fron-assets/js/instantpages.5.1.0.min.js') }}"></script>
<script src="{{ asset('fron-assets/js/lazyload.17.6.0.min.js') }}"></script>
<script src="{{ asset('fron-assets/js/slick.min.js') }} "></script>
<script src="{{ asset('fron-assets/js/custom.js') }} "></script>
